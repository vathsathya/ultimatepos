<div class="pos-tab-content">
    ...
    @php
        ...
        if(isset($details['btns']) && isset($details['btns']['navbar']) && !empty($details['btns']['navbar']['drop_down_text'])) {
            $navbar_btn['drop_down_text'] = $details['btns']['navbar']['drop_down_text'] ?? 'Pages';
        }
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                {!! Form::label('navbar_btn_page', __('cms::lang.page_drop_down_text') . ':' )!!}
                                {!! Form::text('btns[navbar][drop_down_text]', $navbar_btn['drop_down_text'], ['class' => 'form-control', 'id' => 'navbar_btn_link']) !!}
                            </div>
                        </div>
                    </div>
                </div>
