        ...
        @for($i = 1; $i <=2 ; $i++)
            <div class="col-xs-6 in_app_chat_div mb-5">
                <div class="form-group mb-0">
                    ...
                    {!! Form::text("chat[mobile][{$i}]", (isset($details['chat']) && isset($details['chat']['mobile']) && isset($details['chat']['mobile'][$i])) ? $details['chat']['mobile'][$i] : '', ['class' => 'form-control input_number', 'id' => "mobile_number_{$i}"]) !!}
                </div>
        ...
        @for($i = 1; $i <=2 ; $i++)
            <div class="col-xs-6 in_app_chat_div mb-5">
                <div class="form-group mb-0">
                    ...
                    {!! Form::text("chat[whatsapp][{$i}]", (isset($details['chat']) && isset($details['chat']['whatsapp']) && isset($details['chat']['whatsapp'][$i])) ? $details['chat']['whatsapp'][$i] : '', ['class' => 'form-control input_number', 'id' => "whatsapp_number_{$i}"]) !!}
                </div>
                <small class="help-text">
                    @lang('cms::lang.contact_no_help_text')
                </small>
