                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        {!! Form::radio('page_position', 'page_dropdown', true, ['class' => 'form-check-input']) !!} @lang('cms::lang.page_dropdown')
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        {!! Form::radio('page_position', 'seperate_menu', false, ['class' => 'form-check-input']) !!} @lang('cms::lang.seperate_menu')
                                    </label>
                                </div>
                            </div>
                        </div>
