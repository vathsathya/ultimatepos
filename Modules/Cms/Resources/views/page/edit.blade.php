            ...
            <div class="col-md-3">
                @component('components.widget', ['class' => 'box-solid'])
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('page_position', __('cms::lang.display_position') . ':' )!!}
                                <div class="form-check">
                                    <label class="form-check-label">
                                        {!! Form::radio('page_position', 'page_dropdown', $page->page_position == 'page_dropdown', ['class' => 'form-check-input']) !!} @lang('cms::lang.page_dropdown')
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        {!! Form::radio('page_position', 'seperate_menu', $page->page_position == 'seperate_menu', ['class' => 'form-check-input']) !!} @lang('cms::lang.seperate_menu')
                                    </label>
                                </div>
                            </div>
                        </div>
