    ...
    <div class="col-md-3">
        <div class="form-group">
            <div class="checkbox">
                ...
                <label>
                    {!! Form::checkbox(
    'production_list_is_final',
    1,
    false,
    ['class' => 'input-icheck', 'id' => 'production_list_is_final']
) !!}
                    {{ __('manufacturing::lang.finalize') }}
                </label>
            </div>
        </div>
    </div>
...
<!-- /.content -->
<div class="modal fade" id="recipe_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
</div>
@stop
@section('javascript')
