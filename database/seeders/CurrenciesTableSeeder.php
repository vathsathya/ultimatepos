...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['id' => '133', 'country' => 'Bangladesh', 'currency' => 'Taka', 'code' => 'BDT', 'symbol' => '৳', 'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
        ];

        Currency::insert($data);

        Currency::insert([
            ['country' => 'Algeria', 'currency' => 'Algerian dinar', 'code' => 'DZD', 'symbol' => 'د.ج', 'thousand_separator' => ' ', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
