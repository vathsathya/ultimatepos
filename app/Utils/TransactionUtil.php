...
class TransactionUtil extends Util
{
            ...
            if (!empty($payment['payment_id'])) {
                ...
                if ($payment_amount != 0) {
                    ...
                    if ($payment['method'] == 'bakong') {
                        $payment_data['transaction_no'] = isset($payment['transaction_no']) ? $payment['transaction_no'] : null;
                    }
    ...
    public function editPaymentLine($payment, $transaction = null, $uf_data = true)
    {
        ...
        if ($payment['method'] == 'bakong') {
            $payment['transaction_no'] = isset($payment['transaction_no']) ? $payment['transaction_no'] : null;
        }
