...
class Util
{
    ...
    public function payment_types($location = null, $show_advance = false, $business_id = null)
    {
        ...
        $payment_types = ['cash' => __('lang_v1.cash'), 'card' => __('lang_v1.card'), 'bakong' => __('lang_v1.bakong'), 'cheque' => __('lang_v1.cheque'), 'bank_transfer' => __('lang_v1.bank_transfer'), 'other' => __('lang_v1.other')];
