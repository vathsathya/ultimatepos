...
class ContactController extends Controller
{
    ...
    public function create()
    {
        ...
        $countries = $this->locationUtil->allCountries();

        return view('contact.create')
            ->with(compact('types', 'customer_groups', 'selected_type', 'module_form_parts', 'users', 'countries'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            $countries = $this->locationUtil->allCountries();
            $states = !empty($contact->country) ? $this->locationUtil->getStates($contact->country) : [];
            $cities = !empty($contact->state) ? $this->locationUtil->getCities($contact->state) : [];

            return view('contact.edit')
                ->with(compact('contact', 'types', 'customer_groups', 'opening_balance', 'users', 'countries', 'states', 'cities'));
        }
    }
