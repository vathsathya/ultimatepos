    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('country', $countries, null, ['class' => 'form-control select2_register', 'placeholder' => __('business.country'), 'required', 'id' => 'country']) !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('state', [], null, ['class' => 'form-control select2_register', 'placeholder' => __('business.state'), 'required', 'id' => 'state']) !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::select('city', [], null, ['class' => 'form-control select2_register', 'placeholder' => __('business.city'), 'required', 'id' => 'city']) !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
