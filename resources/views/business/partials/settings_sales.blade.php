<div class="pos-tab-content">
    <div class="row">
        ...
        {{--<div class="col-sm-12 hide">
            <div class="form-group">
                ...
                <div class="input-group">
                    <div class="radio">
                        <label>
                            <input type="radio" name="sell_price_tax" value="includes" class="input-icheck"
                                @if($business->sell_price_tax == 'includes') {{'checked'}} @endif> Includes the Sale Tax
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="sell_price_tax" value="excludes" class="input-icheck"
                                @if($business->sell_price_tax == 'excludes') {{'checked'}} @endif>Excludes the Sale Tax
                            (Calculate sale tax on Selling Price provided in Add Purchase)
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('amount_rounding_method', __('lang_v1.amount_rounding_method') . ':') !!}
                @show_tooltip(__('lang_v1.amount_rounding_method_help'))
                {!! Form::select(
    'pos_settings[amount_rounding_method]',
    [
    ...
    ['class' => 'form-control select2', 'style' => 'width: 100%;', 'placeholder' => __('lang_v1.none')]
) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[allow_overselling]',
    1,
    ...
    ['class' => 'input-icheck']
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[enable_sales_order]', 1, !empty($pos_settings['enable_sales_order']), ['class' => 'input-icheck', 'id' => 'enable_sales_order']) !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[is_pay_term_required]', 1, !empty($pos_settings['is_pay_term_required']), ['class' => 'input-icheck', 'id' => 'is_pay_term_required']) !!}
                        {{ __('lang_v1.is_pay_term_required') }}
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('pos_settings[is_commission_agent_required]', 1, !empty($pos_settings['is_commission_agent_required']), ['class' => 'input-icheck', 'id' => 'is_commission_agent_required']) !!}
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('bakong_account_id', 'Bakong Account ID:') !!}
                {!! Form::text('pos_settings[bakong_account_id]', $pos_settings['bakong_account_id'] ?? '', ['class' => 'form-control', 'id' => 'bakong_account_id']) !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('bakong_token', 'Bakong Token:') !!}
                {!! Form::text('pos_settings[bakong_token]', $pos_settings['bakong_token'] ?? '', ['class' => 'form-control', 'id' => 'bakong_token']) !!}
            </div>
        </div>
    </div>
</div>