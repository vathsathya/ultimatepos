            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('country', $countries, $location->country, ['class' => 'form-control', 'id' => 'location_country', 'placeholder' => __('business.country'), 'required']) !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('state', __('business.state') . ':*') !!}
                        {!! Form::select('state', $states, $location->state, ['class' => 'form-control', 'id' => 'location_state', 'placeholder' => __('business.state'), 'required']) !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('city', $cities, $location->city, ['class' => 'form-control', 'id' => 'location_city', 'placeholder' => __('business.city'), 'required']) !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                                ...
                                @foreach($payment_types as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {!! Form::checkbox('default_payment_accounts[' . $key . '][is_enabled]', 1, !empty($default_payment_accounts[$key]['is_enabled'])) !!}
                                        </td>
