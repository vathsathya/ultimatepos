<div class="modal-dialog modal-lg" role="document">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-15">
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio" @if($contact->contact_type == 'individual') checked
    ...
    ['class' => 'form-control', 'placeholder' => __('business.business_name')]
                ...
                <div class="col-sm-4">
                    <div class="form-group individual" @if($contact->contact_type == 'business') style="display: none;"
                    @endif>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('country', $countries, $contact->country, ['class' => 'form-control', 'id' => 'contact_country', 'placeholder' => __('business.country')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('state', $states, $contact->state, ['class' => 'form-control', 'id' => 'contact_state', 'placeholder' => __('business.state')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('city', $cities, $contact->city, ['class' => 'form-control', 'id' => 'contact_city', 'placeholder' => __('business.city')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
