                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('country', $countries, null, ['class' => 'form-control', 'id' => 'contact_country', 'placeholder' => __('business.country')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('state', [], null, ['class' => 'form-control', 'id' => 'contact_state', 'placeholder' => __('business.state')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('city', [], null, ['class' => 'form-control', 'id' => 'contact_city', 'placeholder' => __('business.city')]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
